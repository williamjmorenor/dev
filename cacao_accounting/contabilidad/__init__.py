...
def naming_series_new():
    ...
    from cacao_accounting.database import Entity, NamingSeries
...
@contabilidad.route("/naming-series/<series_id>/toggle-default")
@login_required
@modulo_activo("accounting")
@verifica_acceso("accounting")
...
@contabilidad.route("/naming-series/<series_id>/toggle-active")
@login_required
@modulo_activo("accounting")
@verifica_acceso("accounting")
